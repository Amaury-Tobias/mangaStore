...
public class UserJDBCTemplate {
    ...
    public void newUser(User user) {
        ...
        Object[] params = new Object[] { user.getUserName(), user.getPassword(), true, user.getEmail(), user.getName(),
                user.getLastName(), user.getPhone(), user.getAddress(), user.getAvatar(), user.getCover() };
